;(function($) {
  ...
  var categories = [
    { name: 'people', label: '인물' },
    { name: 'nature', label: '자연' },
    { name: 'food', label: '음식' },
    { name: 'activity', label: '활동' },
    { name: 'travel', label: '여행&장소' },
    { name: 'object', label: '사물' },
    { name: 'symbol', label: '심볼' },
    { name: 'flag', label: '깃발' }
  ];
  ...
  $.extend(EmojiPicker.prototype, {
    ...
    updatePosition: function() {
      ...
      */
      ...
      this.$picker.css({
//        top: $('.btnAddLetter').offset().top + 30,
          left: $('.btnAddLetter').offset().left - 200
      });
    ...
    emojiTabMouseover: function(e) {
      ...
      if (categoryTitle == '') { categoryTitle = '사용된 이모티콘'; }
  ...
  function getPickerHTML() {
    ...
    if (localStorageSupport) {
      ...
      nodes.push('<h1>사용된 이모티콘</h1><div class="wrap">');
